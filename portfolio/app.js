...
const images = [
  ...
  {
    src: "../portfolio/img/accuraCore.png",
    categories: ["all"],
    title: "AccuraCore",
    description:
  ...
  {
    src: "../portfolio/img/sparxsolar.png",
    categories: ["all"],
    title: "Sparx Solar",
    description:
  ...
  {
    src: "../portfolio/img/swha.png",
    categories: ["all"],
    title: "Khana Sab K Liye",
    description:
      "A food delivery and mangement app made for poor and needy peoples using Firebase Firestore and React Native. This was a submission for the Final Hackathon for Saylani Welfare SMIT (InComplete)",
  },
  {
    src: "../portfolio/img/wa.png",
    categories: ["all"],
    title: "Whatsapp Clone (UI)",
    description:
      "A Whatsapp Clone App UI made using React Native and React Navigation",
  },
  {
    src: "../portfolio/img/rnt.png",
    categories: ["all"],
    title: "Login & Sign Up App",
    description:
      "A Simple Login and SignUp app made with the help of React navigation",
  },
  ...
  // REACT NATIVE PROJECTS STARTS HERE
  {
    src: "../portfolio/img/wa.png",
