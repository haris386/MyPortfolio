...
const images = [
    { src: '../portfolio/img/tha.png', categories: ['all'], title: 'Hire App', description: 'Built Hire App for employers to onboard seamlessly, create jobs, launch skill based assessments, and invite thousands of global candidates for job matching and interviews, all with detailed dashboards.' },
    { src: '../portfolio/img/tcp.png', categories: ['all'], title: 'Candidate Portal', description: 'Developed Candidate Portal, enabling seamless AI-powered on-boarding for technologists, skill assessments with certifications, and job matching, serving thousands of global users.' },
      { src: '../portfolio/img/sparxtech.png', categories: ['all'], title: 'SparX Technologies', description: 'SparX Technologies made using NextJs delivers AI-powered digital solutions, from claims automation to real-time video analytics, enabling businesses to operate smarter and faster. Their scalable cloud-native platforms drive efficiency, security, and innovation across industries.' },
  { src: '../portfolio/img/accuraCam.png', categories: ['all'], title: 'AccuraCam', description: 'AccuraCam made using NextJs simplifies photo documentation for claims and field operations with AI-driven tagging, metadata embedding, and seamless system integration. It ensures instant syncing, secure sharing, and effortless organization across platforms.' },
  { src: '../portfolio/img/accuraCore.png', categories: ['all'], title: 'AccuraCore', description: 'AccuraCore made using NextJs is an all-in-one business management platform that unifies workflows, financial automation, and team collaboration under a single dashboard. It offers customizable processes, smart reporting, and complete operational control for growing enterprises.' },
  ...
  { src: '../portfolio/img/sparxtech.png', categories: ['react'], title: 'SparX Technologies', description: 'SparX Technologies made using NextJs delivers AI-powered digital solutions, from claims automation to real-time video analytics, enabling businesses to operate smarter and faster. Their scalable cloud-native platforms drive efficiency, security, and innovation across industries.' },
  { src: '../portfolio/img/accuraCam.png', categories: ['react'], title: 'AccuraCam', description: 'AccuraCam made using NextJs simplifies photo documentation for claims and field operations with AI-driven tagging, metadata embedding, and seamless system integration. It ensures instant syncing, secure sharing, and effortless organization across platforms.' },
  { src: '../portfolio/img/accuraCore.png', categories: ['react'], title: 'AccuraCore', description: 'AccuraCore made using NextJs is an all-in-one business management platform that unifies workflows, financial automation, and team collaboration under a single dashboard. It offers customizable processes, smart reporting, and complete operational control for growing enterprises.' },
  ...
  // { src: '../portfolio/img/rcm.png', categories: ['react'], title: 'Redux Cart Manager', description: '' },
